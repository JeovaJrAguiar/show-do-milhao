...
import api.showdomilhao.security.CustomTokenEnhancer;
import api.showdomilhao.security.UserDetailsServiceImpl;
...
public class OAuthConfiguration {
    ...
    private static final String RESOURCE_ID = "ShowDoMilhao";
